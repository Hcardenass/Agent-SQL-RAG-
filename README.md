...
Explicación del flujo conversacional
  ...
  6.	Pruebas                                                                                                                                                                   
     ...
     ![Pregunta6](Images/Pregunta5.png)
...
El proceso de fragmentar documentos (“chunking”) es crítico: un corte inadecuado puede omitir información clave o generar contexto erróneo. En mis pruebas, empleé varios criterios de recorte (por párrafo, por número de líneas, por delimitadores semánticos), pero descubrí que lo más fiable es recortar por página. De esta forma, cada fragmento conserva el contexto completo del texto original  (títulos, encabezados o pies de página) y se evita perder datos relevantes que podrían quedar “cortados” al dividir en bloques menores.
